...
Claude Code plugin for token-efficient compressed output with optional ELI5 overlay. Distributed via the [acorn](https://github.com/skjangx/acorn) marketplace.
